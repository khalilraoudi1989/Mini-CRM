...
Route::middleware(['auth', 'checkRole:admin'])->group(function () {
    ...
    Route::get('/companie', [CompanyController::class, 'index'])->name('companie.index');
    Route::get('/companie/create', [CompanyController::class, 'create'])->name('companie.create');
    Route::post('/companie/store', [CompanyController::class, 'store'])->name('companie.store');
});
