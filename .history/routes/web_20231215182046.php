...
Route::get('/invitation/{token}', 'App\Http\Controllers\CompanyController@accept')->name('invitation.accept');
Route::get('/invitations/create', 'App\Http\Controllers\CompanyController@create')->name('invitations.create');
