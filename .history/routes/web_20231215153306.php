...
Route::middleware(['auth', 'checkRole:admin'])->group(function () {
    ...
    Route::get('/companie', 'App\Http\Controllers\CompanyController@index')->name('companie.index');
    Route::get('/companie/create', 'App\Http\Controllers\CompanyController@create')->name('companie.create');
    Route::post('/companie/store', 'App\Http\Controllers\CompanyController@store')->name('companie.store');
});
