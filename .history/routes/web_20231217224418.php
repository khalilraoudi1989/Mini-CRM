...
Route::middleware(['auth', 'checkRole:admin'])->group(function () {
    ...
    Route::get('/admin/history', 'App\Http\Controllers\AdminController@history')->name('admin.history');
});
...
Route::middleware(['auth', 'checkRole:employee'])->group(function () {
    ...
    Route::get('/employee/profile', 'App\Http\Controllers\EmployeeController@profile')->name('employee.profile');
    Route::patch('/employee/update-profile', 'App\Http\Controllers\EmployeeController@updateProfile')->name('employee.update-profile')->middleware('auth');
