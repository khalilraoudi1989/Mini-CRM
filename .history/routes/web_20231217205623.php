...
Route::middleware(['auth', 'checkRole:employee'])->group(function () {
    ...
    Route::get('/employee/company-details', 'App\Http\Controllers\EmployeeController@viewCompanyData')->name('company.show.details');
    Route::get('/employee/employee-details', 'App\Http\Controllers\EmployeeController@viewDetails')->name('employee.show.details');
});
