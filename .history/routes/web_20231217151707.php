...
Route::middleware(['auth', 'checkRole:admin'])->group(function () {
    ...
    Route::get('/invitation/accept/{token}', 'App\Http\Controllers\InvitationController@accept')->name('invitation.accept');
    Route::get('/invitation/accept/{token}', 'App\Http\Controllers\InvitationController@showRegistrationForm');
    Route::post('/invitation/accept/{token}', 'App\Http\Controllers\InvitationController@processRegistration');
