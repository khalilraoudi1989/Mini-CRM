...
Route::middleware(['auth', 'checkRole:admin'])->group(function () {
    ...
    Route::get('/invitation/accept/{token}', 'App\Http\Controllers\InvitationController@showRegistrationForm')->name('invitation.showRegistrationForm');
    Route::post('/invitation/accept/{token}', 'App\Http\Controllers\InvitationController@processRegistration')->name('invitation.processRegistration');
