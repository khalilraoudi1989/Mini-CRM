...
Route::middleware(['auth', 'checkRole:employee'])->group(function () {
    ...
    Route::get('/employee/{employee_id}/details', 'App\Http\Controllers\EmployeeController@viewCompanyData')->name('employee.show.details');
    Route::get('/company/{company_id}/details', 'App\Http\Controllers\CompanyController@viewDetails')->name('company.show.details');
});
